            ...
            <div className="about-content">
              <div className="about-creators-container">
                <div className="about-creators-bio">
                  ...
                  <p
                    ...
                    data-aos="zoom-in"
                  >
                    Bizler Aydın Adnan Menderes Üniversitesi son sınıf
                    öğrencileriyiz, mezuniyetimiz yaklaşırken bizden sonraki
                    üniversite öğrencilerinin kulüp yöneticileri moderatörlüğü
                    aracılığıyla kendilerini özgürce ifade edebilecekleri, özgür
                    ve bağımsız bir sosyal medya platformu kurup “Adu Connect”
                    ya da “Connect Adu” ismini vermeyi kendimize sorumluluk
                    olarak gördük!
                  </p>
                </div>
              ...
              <div className="about-cards-section">
                <Aboutcard
                  ...
                  paragraph={
                    "Merhaba! Okul kulübümüzün resmi sosyal medya uygulamasına hoş geldiniz. Biz, Aydın Adnan Menderes Üniversitesi öğrencileri olarak bu platformda bir araya geldik! Amacımız, doğrultusunda kulüp etkinlikleri düzenleyerek öğrenciler arasında birlik ve dayanışma sağlamaktır. Sosyal medya platformumuzda, kulüp etkinlikleri, başarılarımız, projelerimiz ve daha fazlası hakkında güncel bilgileri paylaşacağız. Siz de platformumuzu desteklemek ve bizimle etkileşimde bulunmak için üye olabilirsiniz. Birlikte daha güçlüyüz, birlikte daha başarılıyız! #AduConnect #ConnectAdu"
                  }
                />
